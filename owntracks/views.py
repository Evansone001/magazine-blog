...
def convert_to_amap(locations):
    ...
    while item:
        ...
        key = 'AIzaSyCdO3y9-Q3yfRDOOIvNIO44btugYRCe3RI'
        api ='https://maps.googleapis.com/maps/api/staticmap?key=AIzaSyCdO3y9-Q3yfRDOOIvNIO44btugYRCe3RI&signature=cJd1IKnmbfaDO9diLRgP-D279vY='
