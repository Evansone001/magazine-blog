...
def emailconfirm(request, id, sign):
    ...
    site = get_current_site().domain
    content = '''
     <p>Congratulations, you have successfully bound your mailbox, you can use {type} to log in to this website directly without password. Welcome to continue to pay attention to this website, the address is</p>
...
def bindsuccess(request, oauthid):
    ...
    if type == 'email':
        ...
        content = "Congratulations, the binding is one step away, please log in to your mailbox to check the email to complete the binding, thank you。"
    else:
        title = 'Binding succeeded'
        content = "Congratulations on your successful binding. You can use {type} to log in to this site directly without a password. Thank you for your attention to this site.".format(
            type=oauthuser.type)
